...
## Analysis
Looking at the table, I created two pivot tables. One gathered the number of calls per zip code and the other gathered the complaints per borough. I chose these specifically because the boroughs give a broader geographical look of the noice complaints while the zip codes give a more narrow view. In order to visualize the data better, I made two bar charts:
